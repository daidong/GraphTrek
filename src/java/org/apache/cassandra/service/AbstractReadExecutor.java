...
public abstract class AbstractReadExecutor
{
    ...
    private static class SpeculatingReadExecutor extends AbstractReadExecutor
    {
        ...
        /*
         * @author daidong. This is where the real read/query happens. 
         */
        public void executeAsync()
        {
            ...
            else
            {
            	...
            	// @daidong. We just make request to the first replica. and then make digest requests to all the remained replicas
