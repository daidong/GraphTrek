...
public class StorageService extends NotificationBroadcasterSupport implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    public StorageService()
    {
        ...
        // @daidong For Travel
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.SEND_TRAVEL_COMMAND, new ReceiveTravelCommandVerbHandler());
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.SEND_LOCAL_READ, new ReceiveLocalReadCommandVerbHandler());
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.CONTROL_START_RS, new ReceiveStartReadShuffleCommandVerbHandler());
