...
public final class MessagingService implements MessagingServiceMBean
{
    ...
    public enum Verb
    {
        ...
        // @daidong. We use UNUSED_1 as SEND_TRAVEL_COMMAND; UNUSED_2 as SEND_READ_COMMAND; UNUSED_3 as SEND_CONTROL_START
        SEND_TRAVEL_COMMAND,
        SEND_LOCAL_READ,
        CONTROL_START_RS,
        ;
    ...
    {{
        ...
        put(Verb.SEND_TRAVEL_COMMAND, Stage.READ);
        put(Verb.SEND_LOCAL_READ, Stage.READ);
        put(Verb.CONTROL_START_RS, Stage.READ);
    ...
    {{
        ...
        // @daidong 
        put(Verb.SEND_TRAVEL_COMMAND, TravelCommand.serializer);
        put(Verb.SEND_LOCAL_READ, SendLocalReadCommand.serializer);
        put(Verb.CONTROL_START_RS, StartReadAndShuffleCommand.serializer);
    ...
    {{
        ...
        // @daidong
        put(Verb.SEND_TRAVEL_COMMAND, TravelResponse.serializer);
        put(Verb.SEND_LOCAL_READ, SendLocalReadResponse.serializer);
        put(Verb.CONTROL_START_RS, StartReadAndShuffleResponse.serializer);
    ...
    /* @daidong Travel command lookup table for registering on-going travel commands */
    public static Map<Integer, TravelCommand> runningTravelCommands = new HashMap<Integer, TravelCommand>();
    public static Map<Integer, List<ReadCommand>> currentLocalReadCommands = new HashMap<Integer, List<ReadCommand>>();
    public static Map<Integer, Integer> currentRunningStep = new HashMap<Integer, Integer>();
    ...
    public int sendTM(MessageOut message, InetAddress to, IAsyncCallback cb){
    	//logger.info("@daidong debug: " + message.getTimeout());
    	int id = addCallback(cb, message, to, message.getTimeout(), false);
    ...
    {
    	//logger.info("@daidong debug: in MessagingService.receive. The received message is: " + message.verb);
